...
const Icon: IconType = memo(({ size = '1em', style, ...rest }) => {
  return (
    ...
    >
      ...
      <path d="M100 20 L120 80 L140 80 L90 140 L110 100 L80 100 Z" fill="currentColor" />
      {/* Simplified representation - this is a placeholder */}
      {/* The actual logo requires proper vectorization of the PNG */}
      <text fill="currentColor" fontSize="40" fontWeight="bold" textAnchor="middle" x="100" y="180">
        雷石
      </text>
    </svg>
  );
